...
export type CatalogCake = { id: string; name: string; slug: string; description: string | null; ingredients: string | null; allergens: string | null; price: number; currency: string; isFeatured: boolean; categories: CatalogCategory[]; images: Array<{ url: string | null; altText: string | null }>; variants: CatalogVariant[]; customizations?: CatalogCustomization[] };
