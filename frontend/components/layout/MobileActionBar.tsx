...
type ActionIcon = "home" | "cart" | "shop" | "wishlist";
...
export default function MobileActionBar() {
  ...
  const hidden = ["/admin", "/login", "/register", "/forgot-password", "/reset-password", "/verify-email"].some((route) => pathname.startsWith(route));
