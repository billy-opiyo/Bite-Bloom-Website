...
6. **Payments** — select and integrate a payment provider, create payment attempts, webhook signature verification, idempotent payment updates, failure/cancellation/refund handling. No payment provider has been selected or installed.
